...
# Kérjük be a felhasználótól az IP-címet
  ...
  read -p "Add meg a domain nevet (pl. example.local): " domain_name
...
# Telepítés
  echo ${bold}${yellow}Installing BIND9...${normal}
...
# Restart BIND9 service
  echo ${bold}${yellow}Restarting BIND9...${normal}
  sudo systemctl restart bind9
  sudo systemctl enable bind9

# Kiírás
  echo ${bold}${yellow}BIND9 configuration successfully applied!${normal}
